...
<template>
    <section class=" bg-white mt-20 text-black" id="contact">
        <h2 class="px-4 mb-4 text-4xl font-bold text-left text-black xl:pl-16">Let's Connect</h2>
